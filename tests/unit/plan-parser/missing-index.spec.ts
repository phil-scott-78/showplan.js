...
describe('missing index', () => {
    it('can create create simple statement', () => {
        ...
        expect(missingIndex.toCreateIndexString()).to.equal(expectedSql);
    });

    it('can create create simple statement with multiple columns', () => {
        const column = new Column(0, 'Id');
    ...
    it('can create create simple statement with multiple columns and an include statement', () => {
        const column = new Column(0, 'Id');
