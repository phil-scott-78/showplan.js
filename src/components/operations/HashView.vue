<template>
  <div>
      ...
      <defined-values v-if="hash.DefinedValues !== undefined && hash.DefinedValues.length > 0" :definedValues="hash.DefinedValues"></defined-values>
    </div>
</template>

<script lang='ts'>
import { Vue, Component, Prop, Watch } from 'vue-property-decorator';
import { RelOp, Hash } from '@/parser/showplan';
